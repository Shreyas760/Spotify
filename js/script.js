...
async function displayAlbums() {
    try {
        ...
        let array = Array.from(anchors)
            ...
            // Only process links that end with a folder name after /songs/
            if (e.href.includes("/songs/") && !e.href.endsWith("/songs")) {
                // Extract folder name - everything after /songs/
                let folderMatch = e.href.match(/\/songs\/([^\/]+)\/?$/);
                ...
                if (folderMatch) {
                    ...
                    try {
                        ...
                        if (!contentType || !contentType.includes('application/json')) {
                            console.warn(`Response for ${folder} is not JSON`);
                            return;
                        }
    ...
    // Load the playlist whenever the library is clicked 
...
async function main() {
    ...
    // Attach event listeners to the buttons previous, play, next
